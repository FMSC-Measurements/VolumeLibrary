...
{
    public class VolLibMethodProvider_x64 : IVolLibMethodProvider
    {
        ILogger Logger { get; } = LoggerResolver.CreateLogger<VolLibMethodProvider_x64>();
        ...
        private const string DLL_NAME = "win-x64\\vollib.dll";
