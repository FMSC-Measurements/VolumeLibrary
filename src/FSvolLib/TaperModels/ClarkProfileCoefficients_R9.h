...
//  This file contains coefficients for calculation of inside - bark
//  volumes using the equations in research paper SE - 282, "Stem 
//  Profile Equations for Southern Tree Species" by A. Clark and 
//  others(1991).The coefficients were fit specifically for the
//  Eastern Region of the Forest Service.Species codes 1000 and
//  higher are for groups of related species.

constexpr int arySiz = 47;
//int grpIdx = 34;
//int totSpp = arySiz;

//   Spp, dib4in, a4, b4
static constexpr std::array<std::array<double, 4>, arySiz> coefA = { {
...
//    Spp, a17_0, b17_0, r_0, c_0, e_0, p_0, a_0, b_0
static constexpr std::array<std::array<double, 9>, arySiz> coef0 = { {
...
//     Spp, a17_4, b17_4, r_4, c_4, e_4, p_4, q_4
static const std::array<std::array<double, 8>, arySiz> coef4 = { {
...
//   Spp, a17_7, b17_7, r_7, c_7, e_7, p_7, q_7
static constexpr std::array<std::array<double, 8>, arySiz> coef79 = { {
    ...
    {1090, 0.858, -0.131,  7.36, 0.909,   21.,  1.408, 1.957 },
...
static constexpr std::array<int, arySiz> speciesCode = {
   ...
   837,  951,  972, 1000, 1090, 1100, 1300, 1310, 1370, 1400,
  1540, 1740, 1750, 1760, 1800, 1950, 1970
};
